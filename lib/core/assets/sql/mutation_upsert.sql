WITH "sys_area"
         AS (INSERT INTO "public"."sys_area" ("name", "pid") SELECT '洛杉矶' :: text, '1' :: bigint
        ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, pid = EXCLUDED.pid WHERE (("sys_area"."name") = '洛杉矶') RETURNING "public"."sys_area".*)
