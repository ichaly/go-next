      ...
      <el-row :gutter="20">
        <el-col :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
          <div class="pic-error">
            ...
            <img :alt="type" class="pic-error-child left" src="@/assets/images/cloud.png" />
            <img :alt="type" class="pic-error-child" src="@/assets/images/cloud.png" />
            <img :alt="type" class="pic-error-child" src="@/assets/images/cloud.png" />
          </div>
        </el-col>
        <el-col :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
...
const src = new URL(`../assets/images/${type}.png`, import.meta.url).href
